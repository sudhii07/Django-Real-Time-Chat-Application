...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # accounts/context_processors/notifications_lenth
                'friends.context_processors.notifications_length',
                # accounts/context_processors/messages_length
                'friends.context_processors.messages_length',
            ],
        },
    },
]
